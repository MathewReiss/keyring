...
<body>
  ...
  <script>
    ...
    function save(){
      ...
      var return_to = '/insert.php?pin=' + <?php echo $pin ?> + '&return_to=' + encodeURIComponent(getQueryParam('return_to', 'pebblejs://close#')) + '&token=<?php echo $_GET[token]?>&ifttt=' + options.ifttt + '&wu=' + options.wu + '&forecast=' + options.forecast + '&wolfram=' + options.wolfram + '&habits=' + options.habits;//getQueryParams('return_to', 'pebblejs://close#');
